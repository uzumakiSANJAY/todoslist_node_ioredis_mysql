  ...
  schema: {
    ...
    body: {
      ...
      properties: {
        ...
        first_name: { type: "string", default: "Ram" },
        date_of_birth: { type: "string", default: "01-01-2023" },
      },
      required: ["id", "first_name"],
      errorMessage: {
        required: {
          id: "Why no id!", // specify error message for when the
          first_name: "Why no first_name!", // property is missing from input
        },
      },
    },
    response: {
